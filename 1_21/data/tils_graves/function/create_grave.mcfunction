...
$give @s minecraft:poisonous_potato[item_name='"Grave Key"',rarity="uncommon",minecraft:custom_data={tils_graves_compass:1b,tils_graves_owner:$(UUID)},custom_model_data=1,!food]
